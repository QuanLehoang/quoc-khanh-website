...
export const copy = {
    vi: {
        ...
        heroSubtitle: "Kỷ niệm ngày Quốc khánh nước Cộng hòa Xã hội Chủ nghĩa Việt Nam (02/09/1945 - 02/09/2026)",

        explore: "Khám phá ngay",

        history: "Tìm hiểu lịch sử",

        holidayTitle: "Lịch nghỉ Quốc Khánh 2026",

        quote: "Không có gì quý hơn độc lập, tự do. Đó là chân lý bất diệt của dân tộc Việt Nam.",

        featureTitle: "Giá trị cốt lõi",
    ...
    en: {
        ...
        heroSubtitle: "Celebrating the National Day of the Socialist Republic of Vietnam (September 2, 1945 - September 2, 2026)",

        explore: "Explore",

        history: "History",

        holidayTitle: "National Day Holiday 2026",

        quote: "Nothing is more precious than independence and freedom.",

        featureTitle: "Core Values",
